...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Admin</b>BlogLocal</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Faça seu logion para o acesso ao painel do blog.</p>
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="record"> Lembrar de mim
            </label>
          </div>
        </div>
        <!-- /.col -->

...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin" class="logo">
      ...
      <span class="logo-mini"><b>A</b>Blog</span>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo htmlspecialchars( $name, ENT_COMPAT, 'UTF-8', FALSE ); ?> - <?php if( $level == 1 ){ ?>Administrador<?php }else{ ?>Usuário<?php } ?>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/admin/users/<?php echo htmlspecialchars( $id_user, ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
